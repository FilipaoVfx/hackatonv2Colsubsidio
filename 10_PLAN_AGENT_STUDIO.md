...
| **F5 — Cierre** | ✅ 2026-07-25 | `10_FEATURE_AGENT_STUDIO.md` con la tabla antes/después, el contrato de seguridad, la honestidad metodológica y cómo verificar. `04_EVENT_CATALOG.md` §6.1 declara el bus del Playground y su lista de consumidores, y la regla de invariancia 6 lo fija como única excepción declarada. En la consola, las secciones no construidas (voz, canales, experimentos, analíticas de configuración y las perillas de conocimiento/memoria/razonamiento) aparecen como roadmap en texto, sin controles que simulen funcionar |
